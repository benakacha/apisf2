...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'nmpolo_rest.controller.groups' => 'getNmpoloRest_Controller_GroupsService',
            'nmpolo_rest.controller.user' => 'getNmpoloRest_Controller_UserService',
            'nmpolo_rest.repo.groups' => 'getNmpoloRest_Repo_GroupsService',
            'nmpolo_rest.repo.user' => 'getNmpoloRest_Repo_UserService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'apisf2', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Nmpolo/RestBundle/Entity'))), 'Nmpolo\\RestBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('NmpoloRestBundle' => 'Nmpolo\\RestBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d58d57937de6e925d7ee135e8f233151810361915d307f07250a217f71101232');
    ...
    {
        return $this->services['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('Y-m-d\\TH:i:sO', 'Africa/Tunis', true);
    }
    ...
    /**
     * Gets the 'nmpolo_rest.controller.groups' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Nmpolo\RestBundle\Controller\GroupsController A Nmpolo\RestBundle\Controller\GroupsController instance.
     */
    protected function getNmpoloRest_Controller_GroupsService()
    {
        return $this->services['nmpolo_rest.controller.groups'] = new \Nmpolo\RestBundle\Controller\GroupsController($this->get('doctrine.orm.default_entity_manager'), $this->get('nmpolo_rest.repo.groups'), $this->get('form.factory'), $this->get('router'));
    }

    /**
     * Gets the 'nmpolo_rest.controller.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Nmpolo\RestBundle\Controller\UserController A Nmpolo\RestBundle\Controller\UserController instance.
     */
    protected function getNmpoloRest_Controller_UserService()
    {
        return $this->services['nmpolo_rest.controller.user'] = new \Nmpolo\RestBundle\Controller\UserController($this->get('doctrine.orm.default_entity_manager'), $this->get('nmpolo_rest.repo.user'), $this->get('form.factory'), $this->get('router'));
    }

    /**
     * Gets the 'nmpolo_rest.repo.groups' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Nmpolo\RestBundle\Entity\GroupsRepository A Nmpolo\RestBundle\Entity\GroupsRepository instance.
     */
    protected function getNmpoloRest_Repo_GroupsService()
    {
        return $this->services['nmpolo_rest.repo.groups'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('Nmpolo\\RestBundle\\Entity\\Groups');
    }

    /**
     * Gets the 'nmpolo_rest.repo.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Nmpolo\RestBundle\Entity\UserRepository A Nmpolo\RestBundle\Entity\UserRepository instance.
     */
    protected function getNmpoloRest_Repo_UserService()
    {
        return $this->services['nmpolo_rest.repo.user'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('Nmpolo\\RestBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $j->setOptions(array('login_path' => '/demo/secured/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $k->setOptions(array('login_path' => '/demo/secured/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($g, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'secured_area', $a, $c), 2 => $i, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $h, 'secured_area', $j, $k, array('check_path' => '/demo/secured/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $g, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $h, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $h, '/demo/secured/login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Nmpolo/RestBundle/Resources/views'), 'NmpoloRest');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'NmpoloRestBundle' => 'Nmpolo\\RestBundle\\NmpoloRestBundle',
